...
After a series of evaluation and testing, I found that I have noticed that users have a basic need for interpersonal skills. Especially now during the pandemic when it is difficult to meet new people, users can use GenMeet to have the opportunity to meet other people regardless of where they are located. This also applies to the elderly, pandemic or not, who had gone through retirement and are in need to continue exercising their interpersonal skills. From my own observations, those services are not widely used among people my age. 
